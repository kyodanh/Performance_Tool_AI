...
describe('Code generation', () => {
  ...
  describe('generateScript', () => {
    it('should generate script', () => {
      ...
      // Generated by LoadPilot (0.0.0) on ${fakeDate.toISOString()}
    ...
    it('marks wizard-configured generators in the script header', () => {
      ...
      expect(script).toContain(
        `// Generated by LoadPilot (0.0.0) on ${fakeDate.toISOString()} (test-setup-wizard)`
      )
    })
  })
